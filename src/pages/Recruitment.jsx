    ...
    <div className= 'page'>
      <div className='team-photo'>
          <div className = 'info-box'>
            <h1 className='title-header'>Recruitment</h1>
            ...
            Please note that the <b className = 'gpta'> General Project Team Application </b>must be completed in addition to the CU GeoData Application.</p>
            <p><a href="https://docs.google.com/forms/d/e/1FAIpQLSf-hJH-No53xT1Wx4IZA_eUKRsOpr_6ME9ks5nx4YTBbquT0A/closedform" target="_blank" rel="noopener noreferrer">CU GeoData Application Form</a></p>
            <p><a href="https://cornell.ca1.qualtrics.com/jfe/form/SV_cuXl2vYgb5sNPWS" target="_blank" rel="noopener noreferrer" >General Project Team Application </a></p>
          </div>
        </div>
    </div>
    </>
